...
<div class="codepay"> <img id="code_img" runat="server" src="#" /> </div>
...
<div id="success_div" class="text-center" style="display:none;"> <i class="zi zi_checkcircle" style="color:green;font-size:50px;"></i>
