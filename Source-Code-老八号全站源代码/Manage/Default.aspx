...
<div class="m_top_bottom nav-scroller">
	...
	<ul class="menu8 nav nav-underline sys_overhid">
	  ...
	  <ul class="menu9 nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu9_2" onclick="showleft('menu9_12','AddOn/StructList.aspx')"><%=Resources.L.组织结构 %></a></li>
...
<%--					<li id="menu3_5_1"><a href="javascript:;" data-url="/AdminMVC/Sale/SaleByDay">按日统计</a></li>
			...
			<div id="menu7" class="m_left_ul">
				...
				<li class="pl-0"><p class="menu_tit laybtn below"><i class="zi zi_forDown" zico="下指"></i> 广告管理</p>
					<ul>
                        ...
                        <li id="menu7_2_9"><a href="javascript:;" data-url="Plus/AD/Banner.aspx">智能Banner</a></li>
					<li id="menu7_2_4"><a href="javascript:;" data-url="Content/ECharts/Default.aspx">图表管理</a></li>
					</ul>
					</li>
                    <li class="pl-0">
                        <p class="menu_tit laybtn below"><i class="zi zi_forDown" zico="下指"></i>名片设计</p>
                        <ul>
			...
			<div id="menu9" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu9_9">
					...
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 组织结构</li>
					<li id="menu9_12_1"><a href="javascript:;" data-url="Addon/StructList.aspx">部门列表</a></li>
					<li id="menu9_12_2"><a href="javascript:;" data-url="Addon/StructChart.aspx">部门图表</a></li>
				</ul>
