...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="row card Settlbody">
        ...
        <div class="bordered card-body shopInvoice">
            <p><i class="zi zi_th strong"></i> 发票信息</p>
            <asp:Literal runat="server" ID="Invoice_Lit" EnableViewState="false"></asp:Literal>
        </div>
		</div>
        <div class="card bordered">
            <div class="card-header mb-1 shop_list_t" onClick="showlistbox('.orderbody')"><i class="zi zi_cubes strong"></i> 商品清单: 
            ...
            <div class="card-body indent orderbody">
                ...
                <ul class="extend_ul">
                    <li runat="server" visible="false" id="userli">
                         <p><a href="javascript:;" onclick="$('#userlist_div').toggle();" title="显示顾客详情"><i class="zi zi_users"></i> 顾客与联系人列表</a></p>
                    ...
                    <li>
                        <div><a href="javascript:;" onclick="$('#arrive_div').toggle();"><i class="zi zi_pluscircle"></i> 优惠券</a></div>
                        <asp:Literal runat="server" ID="Arrive_Lit" EnableViewState="false"></asp:Literal>
                    </li>
                    <li id="point_li">
                        <div><a href="javascript:;" onclick="$('.point_div').toggle();"><i class="zi zi_pluscircle"></i> 积分抵扣</a></div>
                    ...
                    <li>
                       <div><a href="javascript:;" onclick="$('#oremind_div').toggle();"><i class="zi zi_pluscircle"></i> 订单备注</a></div>
        ...
        <div class="total_div total_divPC card-footer text-right">
            <span class="total">应付总额：</span><asp:Button runat="server" CssClass="btn btn-info btn-lg ml-2" ID="AddOrder_Btn" Text="提交订单" OnClientClick="return subCheck();" OnClick="AddOrder_Btn_Click" />
        </div>

        <section class="fixed-bottom fixed_Set">
            <span class="Settlement_tex total">应付总额: <i runat="server" id="totalmoney_i" class="zi zi_yensign"></i> 0.00</span>
