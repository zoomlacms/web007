<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BarContent.aspx.cs" Inherits="ZoomLaCMS.Tools.BarContent" MasterPageFile="~/Common/Master/Empty.master" ValidateRequest="false"%>
...
<a href="../Tools/"><i class="zi zi_redoalt" aria-hidden="true"></i> 返回工具箱</a>
    ...
    <asp:Button runat="server" ID="Compress_Btn" class="btn btn-info btn-sm" Text="压缩字符串" OnClick="Compress_Btn_Click"/>
</div>
</asp:Content>
